...
productList.map((i, data) => {
    if (i.id <= 5) {
        let list = document.getElementById("clothingCards");
        let result = document.createElement("list");
        result.innerHTML = `
    <div class="card">
    <a href="#">
    <div class="img">
    ...
    `
        ...
        let list = document.getElementById("accessoriesCards");
        let result = document.createElement("list");
        result.innerHTML = `
    <div class="card">
    <a href="#">
